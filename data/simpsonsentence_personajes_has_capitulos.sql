...
CREATE TABLE `personajes_has_capitulos` (
  ...
  PRIMARY KEY (`personajes_id_personajes`,`capitulos_id_capitulos`),
  KEY `fk_personajes_has_capitulos_capitulos1_idx` (`capitulos_id_capitulos`),
  KEY `fk_personajes_has_capitulos_personajes1_idx` (`personajes_id_personajes`),
  CONSTRAINT `fk_personajes_has_capitulos_capitulos1` FOREIGN KEY (`capitulos_id_capitulos`) REFERENCES `capitulos` (`id_capitulos`),
  CONSTRAINT `fk_personajes_has_capitulos_personajes1` FOREIGN KEY (`personajes_id_personajes`) REFERENCES `personajes` (`id_personajes`)
